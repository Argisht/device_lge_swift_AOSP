...
status_t QualcommCameraHardware::setSceneMode(const CameraParameters& params)
{
    ...
    if (str != NULL) {
        ...
        if (value != NOT_FOUND) {
            ...
            bool ret = native_set_parm(CFG_SET_SCENE_MODE, sizeof(value),
                                       (void *)&value);
    ...
    if (str != NULL) {
        ...
        if (value != NOT_FOUND) {
           ...
           || (value == CAMERA_EFFECT_AQUA) || (value == CAMERA_EFFECT_SEPIA))
               ...
               bool ret = native_set_parm(CFG_SET_EFFECT, sizeof(value),
                                           (void *)&value);
               return ret ? NO_ERROR : UNKNOWN_ERROR;
          }
        }
...
status_t QualcommCameraHardware::setBrightness(const CameraParameters& params) {
	    ...
	    LOGD("CAMERA_SET_PARM_BRIGHTNESS");
            bool ret = native_set_parm(CFG_SET_BRIGHTNESS, sizeof(mBrightness),
                                       (void *)&mBrightness);
            return ret ? NO_ERROR : UNKNOWN_ERROR;
        } else {
            return NO_ERROR;
...
status_t QualcommCameraHardware::setWhiteBalance(const CameraParameters& params)
{
    ...
    && (value_effect != CAMERA_EFFECT_AQUA) && (value_effect != CAMERA_EFFECT_SEPIA)) {
		...
		LOGD("CAMERA_SET_PARM_WB");
                bool ret = native_set_parm(CFG_SET_WB, sizeof(value),
                                           (void *)&value);
                return ret ? NO_ERROR : UNKNOWN_ERROR;
            }
        }
...
status_t  QualcommCameraHardware::setISOValue(const CameraParameters& params) {
    ...
    if (str != NULL) {
	    ...
	    LOGD("CAMERA_SET_PARM_ISO");
            native_set_parm(CFG_SET_ISO, sizeof(camera_iso_mode_type), (void *)&value);
            return NO_ERROR;
    }
...
status_t QualcommCameraHardware::setZoom(const CameraParameters& params)
{
	...
	LOGD("CAMERA_SET_PARM_ZOOM: %d", zoom_value);
        bool ret = native_set_parm(CFG_SET_ZOOM_VIDEO, sizeof(zoom_value), (void *)&zoom_value);
